					...
					<div className='flex-col h-[80%]'>
						<div className='flex items-center gap-1 flex-col'>
							<code className='flex text-[18px] gap-2 group'>
								<h1>&#x0007B;</h1>
								<h1 className='opacity-50 w-7 text-clip transition-all overflow-clip whitespace-nowrap group-hover:w-[42rem]'>
									Big list Of Lame Gibberish
								</h1>
								<h1
							...
							<Post
								title='Hello World'
								texts={["Congratulations, you found an easter egg."]}
							/>
						</div>
					</div>
					<Footer></Footer>
